...
> An opinionated, curated list of awesome things related to Vue.js

## Introduction
There is an [official Awesome Vue list](https://github.com/vuejs/awesome-vue) from which this is forked. Initially I was contributing to that repository but my vision seems to be a [bit different than the official list](https://github.com/vuejs/awesome-vue/pull/3965). Rather than argue over methodology I decided to diverge from the main list.

So what does this list do differently from the official Awesome Vue? It's still a work in progress but you can already see:
- Within subjects items are often grouped by language to make it easier to find all resources available to specific language groups.
- Many items are sorted into groups by year (updated) as this may help folks quickly determine if the resource available is going to be too old for their use.
- Bolding of link titles are being removed. This seems to have been ad hoc by various contributors when there doesn't seem to be any outstanding reason for one link to be highlighted more than another.
- The section with apps/sites/interactive experiences has been largely removed and a link to [madewithvuejs.com](https://madewithvuejs.com/) provided instead. The Vue Awesome list is quite long and I didn't feel it necessary to duplicate what one can easily find elsewhere.
- Similarly information related to companies' using Vue has been moved to the end as I see this of relatively low value to those most likely to be utilizing this list.

That's pretty much it for now but I have a few other ideas in the wings. Feel free to submit suggestions/corrections/etc.
...
- [Vue.js 3 Style Guide](https://vuejs.org/style-guide/)
- [Vue.js 2 Style Guide](https://vuejs.org/v2/style-guide/)
...
- [WebTechSurvey.com: Vue.js](https://webtechsurvey.com/technology/vue.js) - An extensive list of websites created with the Vue.js Javascript framework.
...
- [The Web Dev's Vue.js Articles](https://thewebdev.info/category/javascript/vue/) - Assorted Vue 2 and 3 tutorials and articles.
...
- [VueConf EU 2017](https://www.youtube.com/channel/UC9dJjbYeXjirDYYVfUD3bSw)
...
- [Create a GitHub File Explorer Using Vue.js](https://www.digitalocean.com/community/tutorials/create-a-github-file-explorer-using-vue-js)
...
- [Medium like Image Loading with Vue.js](https://blog.theodo.com/2016/10/medium-like-image-loading-with-vue-js/)
...
- [ngexplorer-quasar](https://github.com/gustaYo/ngexplorer-quasar) -Implementation of `Ngexplorer` with [quasar framework](https://github.com/rstoenescu/quasar-framework) - 2016
...
#### Spanish
- [Ngexplorer-vuejs-client](https://github.com/gustaYo/ngexplorer-vuejs-client) - Vue client for `Ngexplorer` - 2016
...
- [DejaVue](https://github.com/MiCottOn/DejaVue) - Visualization and debugging tool built for Vue.js. - Updated: 2017
...
- [VueSource](https://github.com/davestewart/vue-source) - Global Vue mixin which identifies components in source code by adding HTML comments - Updated: 2018
...
### Apps/Websites
- See [made with vue.js](https://madewithvuejs.com).
